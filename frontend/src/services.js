...
export function formatRefLabel(serviceName, row) {
...
export const isServiceEnabled = (s) => ENABLED_STACKS.includes(s.stack);
...
const svc = (name, port, language, domain, extra = {}) => {
...
export const serviceByName = (name) => SERVICES.find((s) => s.name === name);
